...
In case, we have $k$ jars to run our test, we will try a different approach. One of the requirements of the algorithm design was that each next iteration was exponientally slower than the previous s
